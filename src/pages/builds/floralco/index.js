  ...
  return (
    <main className="fl-body" style={{ backgroundColor: "#3A3E2C", minHeight: "100vh" }}>
      ...
      <section className="px-6 py-16 sm:px-10 sm:py-20" style={{ backgroundColor: "#454A36" }}>
        <div className="mx-auto grid max-w-4xl items-center gap-10 sm:grid-cols-2">
          ...
          <div>
            ...
            <h2 className="fl-serif mt-2 text-4xl" style={{ color: "#FFFFFF" }}>
              Sunday Morning
            </h2>
            <p className="fl-body mt-3 text-lg leading-relaxed" style={{ color: "#D7DAC5" }}>
      ...
      <section className="px-6 py-16 sm:px-10 sm:py-20">
        <h2 className="fl-serif text-center text-4xl" style={{ color: "#FFFFFF" }}>
          This Week's Favorites
        </h2>
        <p className="fl-body mx-auto mt-3 max-w-md text-center text-base" style={{ color: "#D7DAC5" }}>
        ...
        <div className="mx-auto mt-12 grid max-w-4xl gap-10 sm:grid-cols-3">
          {favorites.map((b) => (
            <Link key={b.name} to="/builds/floralco/shop" className="block text-center">
              ...
              <p className="fl-serif mt-4 text-xl" style={{ color: "#FFFFFF" }}>{b.name}</p>
              <p className="fl-body mt-1 text-lg" style={{ color: "#8A9468" }}>{b.price}</p>
            </Link>
          ))}
        </div>
      </section>
      ...
      <section className="px-6 py-16 text-center sm:px-10 sm:py-20" style={{ backgroundColor: "#2C2F21" }}>
      ...
      <section className="px-6 py-16 text-center sm:px-10 sm:py-20">
        <p className="fl-serif text-3xl" style={{ color: "#FFFFFF" }}>Stay in Bloom</p>
        <p className="fl-body mt-2 text-lg" style={{ color: "#D7DAC5" }}>
          One email a week, new arrangements and seasonal picks.
        </p>
        {subscribed ? (
          <p className="fl-body mt-6 text-sm uppercase tracking-[0.15em]" style={{ color: "#8A9468" }}>
          ...
          <div className="mx-auto mt-6 flex max-w-sm items-center gap-2">
            <input
              ...
              style={{ borderColor: "#8A9468", backgroundColor: "#454A36", color: "#FFFFFF" }}
            />
            <button
              type="button"
