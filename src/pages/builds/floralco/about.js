      ...
      <section className="px-6 pb-12 pt-16 sm:px-10 sm:pt-20">
        <div className="mx-auto grid max-w-4xl items-center gap-12 sm:grid-cols-2">
          <div>
            ...
            <p className="fl-body mt-5 text-xl leading-relaxed" style={{ color: "#5A5F45" }}>
            ...
            <p className="fl-body mt-4 text-xl leading-relaxed" style={{ color: "#5A5F45" }}>
        ...
        <div className="mx-auto mt-12 grid max-w-3xl gap-10 sm:grid-cols-4">
          {timeline.map((t) => (
            <div key={t.year} className="text-center">
              <p className="fl-serif text-2xl" style={{ color: "#6B7355" }}>{t.year}</p>
              <p className="fl-body mt-2 text-sm leading-relaxed" style={{ color: "#5A5F45" }}>{t.body}</p>
            </div>
          ))}
        </div>
      </section>
