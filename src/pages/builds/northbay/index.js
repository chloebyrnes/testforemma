...
export default function NorthbayDashboard() {
  ...
  return (
    <main className="nb-body" style={{ backgroundColor: "#F8FAFC", minHeight: "100vh" }}>
      ...
      <header className="flex flex-wrap items-center justify-between gap-3 border-b px-6 py-4 sm:px-8" style={{ borderColor: "#E2E8F0", backgroundColor: "#FFFFFF" }}>
        <div className="flex min-w-0 items-center gap-3">
          <div
            className="flex h-9 w-9 flex-none items-center justify-center rounded-lg text-xs font-semibold"
            style={{ backgroundColor: "#2563EB", color: "#FFFFFF" }}
          >
            NB
          </div>
          <div className="min-w-0">
            <p className="truncate text-sm font-semibold" style={{ color: "#0F172A" }}>Northbay Supply Co.</p>
            <p className="truncate text-xs" style={{ color: "#94A3B8" }}>Warehouse Operations</p>
          </div>
        </div>
      ...
      <div className="flex gap-1 overflow-x-auto border-b px-6 sm:px-8" style={{ borderColor: "#E2E8F0", backgroundColor: "#FFFFFF" }}>
        {tabs.map((t) => (
          <button
            key={t}
            type="button"
            onClick={() => setTab(t)}
            className="nb-body flex-none whitespace-nowrap border-b-2 px-4 py-3 text-sm font-medium"
            style={{
      ...
      <div className="mx-auto max-w-6xl px-6 py-8 sm:px-8">
        ...
        {tab === "Inventory" && (
          <div>
            ...
            <div className="mt-5 overflow-x-auto rounded-lg border" style={{ borderColor: "#E2E8F0" }}>
