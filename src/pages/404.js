    ...
    <Layout currentPath="/404">
      <section className="relative mx-auto flex min-h-[70vh] max-w-3xl flex-col items-center justify-center px-6 py-20 text-center sm:px-10">
        <div className="relative mx-auto max-w-lg text-center">
          <CornerMarks />
          <CrosshairMark className="mx-auto h-10 w-10 text-[var(--ash-surface)]" />
          <h1 className="mt-4 font-display text-4xl text-[var(--ash-ink)] sm:text-5xl [text-wrap:balance]">
            This page hasn't been drafted yet.
          </h1>
          <p className="mt-3 font-script text-2xl text-[var(--ash-ink)] sm:text-3xl">
            Let's get you back on track.
          </p>
          <p className="mt-6 max-w-md mx-auto text-base leading-relaxed text-[var(--ash-ink)]/80 sm:text-lg">
