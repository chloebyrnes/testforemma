...
export default function PlaceholderPhoto({ label = "Photo", aspect = "aspect-square", className = "" }) {
  return (
    <div
      ...
      style={{ borderColor: "#8A9468", backgroundColor: "#454A36" }}
    >
      <svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" style={{ color: "#FFFFFF" }}>
      ...
      <span className="fl-body px-2 text-center text-xs uppercase tracking-[0.1em]" style={{ color: "#FFFFFF" }}>
        {label}
      </span>
    </div>
  )
